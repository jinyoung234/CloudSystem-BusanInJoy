...
<% request.setCharacterEncoding("utf-8"); %>
    ...
    <body>
        ...
        <section class="page-section portfolio bg-white text-black text-center" id="portfolio">
            <table border-collapse="0" style="margin-left: auto; margin-right: auto;">
                <thead>
                    <%
                    ...
                    String ID = (String)ids;
                        ...
                        String profile = dao.profile;
                        String age = dao.age;
                        %>
                    <tr>
                        <th height="300" width="300" colspan="2" rowspan="2">
                            <div class="box" style="background: White; margin-left: auto; margin-right: auto; ">
                                <img src="User.png">
                            </div>
                        </th>
