                ...
                <body>
                    ...
                    <%  if(search.equals("") || search.equals(" "))
                            ...
                            <script>
                                ...
                                location.href="/SubPage/Festival.jsp";
                            </script><%
                            }
                    %>
                    <%   
                        ...
                        String url1="부산 수국꽃문화축제를 가다";
                        String url2="금정산성축제";
                        String url3="낙동강구포나루축제";
                        String url4="아름다운 부산 밤하늘의 하모니, 부산불꽃축제";
                    %>
                        <section>
                        ...
                        <section class="sub_nav">
                            ...
                            <div class="sub_nav_right">
                                <form class="nav_form" action="Festival.jsp">
                        ...
                        <div  class="col-lg-3 col-md-6">         
                            <div style=" width: 400px; height: 130px; display : flex; align-items: center; margin-right: 5px;" class="card">
                                ...
                                <div style="display: flex; flex-direction: column; justify-content: center; align-items: center;
                                 width: 5rem; height: 10rem;" class="card-body">
