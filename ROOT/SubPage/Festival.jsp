                ...
                <body>
                    ...
                    <% FeedDAO dao=new FeedDAO(); List<FeedDTO> list = dao.selectAll(); %>
                        ...
                        <section class="Ex_image">
                            <div class="img">
                                <span style="font-size:50px; color:black;">Festival</span>
                            </div>
                        </section>

                        <div class="path-section">
                            <div class="icon-img"><img src="/ContentPage/MarketContent/home.png"
                                    style="width:25px; height:25px" />
                            </div>
                            <div class="icon-img"><img src="/ContentPage/MarketContent/arrow-right.png"
                                    style="width:30px; height:25px" />
                            </div>
                            <div class="path-text">
                                <h6 style="font-size : 15px;"><a style="text-decoration: none; color:black;"
                                        href="Festival.jsp">Festival</a></h6>
                            </div>
                            <div class="icon-img"><img src="/ContentPage/MarketContent/arrow-right.png"
                                    style="width:30px; height:25px" />
                            </div>
                        ...
                        <section class="sub_nav">
                            ...
                            <div class="nav_search sub_nav_right">
                                <table>
                                    <thead>
                                        <form class="nav_form" action="FestivalSearch.jsp" method="get">
                                            <tr>
                    ...
                    <div class="row">
                        ...
                        <div  class="col-lg-3 col-md-6">         
                            ...
                            <div style=" width: 400px; height: 130px; display : flex; align-items: center; margin-right: 5px;" class="card">
                                <img src= <% out.print(list.get(0).getF_image()); %> class="card-img-top" alt="...">
                        ...
                        <div class="col-lg-3 col-md-6">         
                            ...
                            <div style=" width: 400px; height: 130px; display : flex; align-items: center; margin-right: 5px;" class="card" style="width: 300px; height: 100px;">
                                <img src= <% out.print(list.get(1).getF_image()); %> class="card-img-top" alt="...">
                                <div style="display: flex; flex-direction: column; justify-content: center; align-items: center; width: 5rem; height: 10rem;" class="card-body">
                        ...
                        <div class="col-lg-3 col-md-6">         
                            ...
                            <div style=" width: 400px; height: 130px; display : flex; align-items: center; margin-right: 5px;" class="card">
                                <img src= <% out.print(list.get(2).getF_image()); %> class="card-img-top" alt="...">
                                <div style="display: flex; flex-direction: column; justify-content: center; align-items: center; width: 5rem; height: 10rem;" class="card-body">
                        ...
                        <div class="col-lg-3 col-md-6">         
                            ...
                            <div style=" width: 400px; height: 130px; display : flex; align-items: center; margin-right: 5px;" class="card">
                                <img src= <% out.print(list.get(3).getF_image()); %> class="card-img-top" alt="...">
                                <div style="display: flex; flex-direction: column; justify-content: center; align-items: center; width: 5rem; height: 10rem;" class="card-body">
