        ...
        <% FeedDAO dao=new FeedDAO(); List<FeedDTO> list = dao.selectAll(); %>
            <section>
                ...
                <section class="Ex_image">
                    <div class="img">
                        <span style="font-size: 50px; color:black">Market</span>
                    </div>
                </section>
                ...
                <section class="sub_nav">
                    ...
                    <div class="nav_search sub_nav_right">
                        <table>
                            <thead>
                                <form class="nav_form" action="MarketSearch.jsp" method="get">
                                    <tr>
                    ...
                    <div class="row">
                        ...
                        <div  class="col-lg-3 col-md-6">         
                            ...
                            <div style=" width: 400px; height: 130px; display : flex; align-items: center; margin-right: 5px;" class="card">
                                <img src= <% out.print(list.get(8).getF_image()); %> class="card-img-top" alt="...">
                                <div style="display: flex; flex-direction: column; justify-content: center; align-items: center; width: 5rem; height: 10rem;" class="card-body">
                                    <p style="font-size : 20px; "class="card-title"><b><% out.print(list.get(8).getF_name()); %></b></p>
                                    <p style="font-size : 14px;"> <% out.print(list.get(8).getF_subName()); %> </p>
                                    <p>조회수 : <% out.print(list.get(8).getF_count()); %> 리뷰수 : <% out.print(list.get(8).getF_reviewcount()); %> </p>
                                    <a href="/ContentPage/MarketContent/MarketContent1.jsp" class="btn btn-light">이동하기</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">         
                            ...
                            <div style=" width: 400px; height: 130px; display : flex; align-items: center; margin-right: 5px;" class="card" style="width: 300px; height: 100px;">
                                <img src= <% out.print(list.get(9).getF_image()); %> class="card-img-top" alt="...">
                                <div style="display: flex; flex-direction: column; justify-content: center; align-items: center; width: 5rem; height: 10rem;" class="card-body">
                                    <p style="font-size : 20px;" class="card-title"><b><% out.print(list.get(9).getF_name()); %></b></p>
                                    <p style="font-size : 14px;"> <% out.print(list.get(9).getF_subName()); %> </p>
                                    <p>조회수 : <% out.print(list.get(9).getF_count()); %> 리뷰수 : <% out.print(list.get(9).getF_reviewcount()); %> </p>
                                    <a href="/ContentPage/MarketContent/MarketContent2.jsp" class="btn btn-light">이동하기</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">         
                            ...
                            <div style=" width: 400px; height: 130px; display : flex; align-items: center; margin-right: 5px;" class="card">
                                <img src= <% out.print(list.get(10).getF_image()); %> class="card-img-top" alt="...">
                                <div style="display: flex; flex-direction: column; justify-content: center; align-items: center; width: 5rem; height: 10rem;" class="card-body">
                                    <p style="font-size : 20px;" class="card-title"><b><% out.print(list.get(10).getF_name()); %></b></p>
                                    <p style="font-size : 14px;"> <% out.print(list.get(10).getF_subName()); %> </p>
                                    <p>조회수 : <% out.print(list.get(10).getF_count()); %> 리뷰수 : <% out.print(list.get(10).getF_reviewcount()); %> </p>
                                    <a href="/ContentPage/MarketContent/MarketContent3.jsp" class="btn btn-light">이동하기</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">         
                            ...
                            <div style=" width: 400px; height: 130px; display : flex; align-items: center; margin-right: 5px;" class="card">
                                <img src= <% out.print(list.get(11).getF_image()); %> class="card-img-top" alt="...">
                                <div style="display: flex; flex-direction: column; justify-content: center; align-items: center; width: 5rem; height: 10rem;" class="card-body">
                                    <p style="font-size : 20px;" class="card-title"><b><% out.print(list.get(11).getF_name()); %></b></p>
                                    <p style="font-size : 14px;"> <% out.print(list.get(11).getF_subName()); %> </p>
                                    <p>조회수 : <% out.print(list.get(11).getF_count()); %> 리뷰수 : <% out.print(list.get(11).getF_reviewcount()); %> </p>
                                    <a href="/ContentPage/MarketContent/MarketContent4.jsp" class="btn btn-light">이동하기</a>
                                </div>
                            </div>
                        </div>
                     </div>
