...
<%@ page import="org.json.simple.parser.ParseException" %>
                    ...
                    <body id="page-top">
                        ...
                        try {
                            ...
                            f.addInfo(5, Maintitle, menu, image, 0, 0);
                            ...
                            <nav class="navbar navbar-expand-xxl navbar-dark fixed-top bg-dark">
                                <div class="container-fluid">
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-lg-4 mb-5 mb-lg-0">
                                                        <h2 class="text-uppercase mb-4"><a style="text-decoration: none; color:black;" href="FoodContent1.jsp"><% 
                                    ...
                                    <div class="path-section">
                                        ...
                                        <div class="path-text">
                                            <h6 style="font-size : 15px;" class="text-uppercase mb-4"><a style="text-decoration: none; color:black;" href="FoodContent1.jsp"><% 
                                                out.print(foodList.get(0));
                                                %></a></h6>
                                        </div>
                                    </div>
                                        ...
                                        <li>
                                            <div class="first-list">
                                                ...
                                                <div class="count">
                                                    ...
                                                    <div>
                                                        <h5><% out.print(feedList.get(4).getF_count()); %>
                                                            <% feedDAO.updateCount(5); %></h5>
                                                    </div>
                                                </div>
                                                <div class="re">
                                                    <div>
                                                    ...
                                                    <div>
                                                        <h5><%=reviewDAO.countReview(5)%></h5>
                                                        <% feedDAO.updateReview(reviewDAO.countReview(5), 5); %>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                            ...
                                            <div id="tab4" class="tab">
                                                <div class="board_wrap">
                                                    ...
                                                    <div class="borad_list_wrap">
                                                        ...
                                                        <div class="bt_wrap">
                                                            <a href="/Review/reviewWriteForm.jsp?fid=5" class="on">리뷰작성</a>
                                                            <!-- <a href="a">작성</a> -->
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <style>
                                    ...
                                    <section>
                                        <footer class="footer text-center fixed-bottom text-white bg-dark fixed-bottom">
                                            <div class="container">
                                                <div class="row">
                                                    <!-- Footer Location-->
                                                    <div class="col-lg-4 mb-5 mb-lg-0">
