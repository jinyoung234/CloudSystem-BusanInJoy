...
<%@ page import="org.json.simple.parser.ParseException" %>
                    ...
                    <body id="page-top">
                        ...
                        try {
                            ...
                            f.addInfo(11, Maintitle, title, image, 0, 0);
                            ...
                            <nav class="navbar navbar-expand-xxl navbar-dark fixed-top bg-dark">
                                <div class="container-fluid">
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-lg-4 mb-5 mb-lg-0">
                                                        <h2 class="text-uppercase mb-4"><a style="text-decoration: none; color:black;" href="MarketContent3.jsp"><% 
                                    ...
                                    <div class="path-section">
                                        ...
                                        <div class="path-text">
                                            <h6 style="font-size : 15px;" class="text-uppercase mb-4"><a style="text-decoration: none; color:black;" href="MarketContent3.jsp"><% 
                                                out.print(marketList.get(0));
                                                %></a></h6>
                                        </div>
                                    </div>
                                        ...
                                        <li>
                                            <div class="first-list">
                                                <div class="score">
                                                    ...
                                                    <div>
                                                        <h5><%=reviewDAO.countRating(11)%></h5>
                                                    </div>
                                                </div>
                                                <div class="count">
                                                    <div>
                                                    ...
                                                    <div>
                                                        <h5><% out.print(feedList.get(10).getF_count()); %>
                                                            <% feedDAO.updateCount(11); %></h5>
                                                    </div>
                                                </div>
                                                <div class="re">
                                                    <div>
                                                    ...
                                                    <div>
                                                        <h5><%=reviewDAO.countReview(11)%></h5>
                                                        <% feedDAO.updateReview(reviewDAO.countReview(11), 11); %>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        <li style="display: flex; width: 480px; justify-content:flex-end; margin-right: 30px;">
                                            <div style="margin-right:10px;" class="last-list">
                                                <div style="padding-top:15px;">
                                                    <a style="font-size:14px; text-decoration: none; color:black;" href="https://search.naver.com/search.naver?sm=tab_hty.top&where=view&query=%ED%95%B4%EC%9A%B4%EB%8C%80%EC%8B%9C%EC%9E%A5&oquery=%ED%95%B4%EC%9A%B4%EB%8C%80%EC%8B%9C%EC%9E%A5&tqi=hphDpwp0J14ssbiOMbRssssstcl-168183&mode=normal"><p style="text-align: center;">추가 정보</p></a>
                                                </div>
                                            </div>
                                            <div class="last-list">
                                                <div style="padding-top:15px;">
        ...
        mapOption = { 
            center: new kakao.maps.LatLng(35.16115, 129.1621), // 지도의 중심좌표
            level: 3 // 지도의 확대 레벨
        };
    ...
    // 마커가 표시될 위치입니다 
    var markerPosition  = new kakao.maps.LatLng(35.16115, 129.1621); 
    ...
    marker.setMap(map);
    var iwContent = '<div style="padding: 1em 2em; margin: 2em 0; font-weight: bold; 5px #000000; "><h4><b>해운대 시장</b></h4> <br> <h6><b>부산광역시 해운대구 구남로 41번길 22-1 </b></h6> </div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
        iwPosition = new kakao.maps.LatLng(35.16115, 129.1621); //인포윈도우 표시 위치입니다
                                            ...
                                            <div id="tab4" class="tab">
                                                <div class="board_wrap">
                                                    ...
                                                    <div class="borad_list_wrap">
                                                        ...
                                                        <div class="bt_wrap">
                                                            <a href="/Review/reviewWriteForm.jsp?fid=11" class="on">리뷰작성</a>
                                                            <!-- <a href="a">작성</a> -->
                                                        </div>
                                                    </div>
                                                </div>
