...
<%@ page import="org.json.simple.parser.ParseException" %>
                    ...
                    <body>
                        ...
                        try {
                            ...
                            f.addInfo(10, Maintitle, title, image, 0, 0);
                            ...
                            <nav class="navbar navbar-expand-xxl navbar-dark fixed-top bg-dark">
                                <div class="container-fluid">
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-lg-4 mb-5 mb-lg-0">
                                                        <h2 class="text-uppercase mb-4"><a style="text-decoration: none; color:black;" href="MarketContent2.jsp"><% 
                                    ...
                                    <div class="path-section">
                                        ...
                                        <div class="path-text">
                                            <h6 style="font-size : 15px;" class="text-uppercase mb-4"><a style="text-decoration: none; color:black;" href="MarketContent2.jsp"><% 
                                                out.print(marketList.get(0));
                                                %></a></h6>
                                        </div>
                                    </div>
                                        ...
                                        <li>
                                            <div class="first-list">
                                                <div class="score">
                                                    ...
                                                    <div>
                                                        <h5><%=reviewDAO.countRating(10)%></h5>
                                                    </div>
                                                </div>
                                                <div class="count">
                                                    <div>
                                                    ...
                                                    <div>
                                                        <h5><% out.print(feedList.get(9).getF_count()); %>
                                                            <% feedDAO.updateCount(10); %></h5>
                                                    </div>
                                                </div>
                                                <div class="re">
                                                    <div>
                                                    ...
                                                    <div>
                                                        <h5><%=reviewDAO.countReview(10)%></h5>
                                                        <% feedDAO.updateReview(reviewDAO.countReview(10), 10); %>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                            ...
                                            <div id="tab4" class="tab">
                                                <div class="board_wrap">
                                                    ...
                                                    <div class="borad_list_wrap">
                                                        ...
                                                        <div class="bt_wrap">
                                                            <a href="/Review/reviewWriteForm.jsp?fid=10" class="on">리뷰작성</a>
                                                            <!-- <a href="a">작성</a> -->
                                                        </div>
                                                    </div>
                                                </div>
