...
<%@ page import="org.json.simple.parser.ParseException" %>
                    ...
                    <body>
                        ...
                        List<FeedDTO> feedList = feedDAO.selectAll();
                            ...
                            try {
                                ...
                                String Maintitle = (String)items.get("SUBTITLE");
                                ...
                                f.addInfo(1, Maintitle, title, image, 0, 0);
                        ...
                        %>  
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-lg-4 mb-5 mb-lg-0">
                                                        <h2 class="text-uppercase mb-4"><a style="text-decoration: none; color:black;" href="FestivalContent1.jsp"><% 
                                    ...
                                    <div class="path-section">
                                        ...
                                        <div class="path-text">
                                            <h6 style="font-size : 15px;" class="text-uppercase mb-4"><a style="text-decoration: none; color:black;" href="FestivalContent1.jsp"><% 
                                                out.print(festivalList.get(0));
                                                %></a></h6>
                                        </div>
                                    </div>
                                        ...
                                        <li>
                                            <div class="first-list">
                                                ...
                                                <div class="count">
                                                    ...
                                                    <div>
                                                        <% feedDAO.updateCount(1); %>
                                                        <h5><% out.print(feedList.get(0).getF_count()); %></h5>
                                                ...
                                                <div class="re">
                                                    ...
                                                    <div>
                                                        <h5><%=reviewDAO.countReview(1)%></h5>
                                                        <% feedDAO.updateReview(reviewDAO.countReview(1), 1); %>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        <li style="display: flex; width: 480px; justify-content:flex-end; margin-right: 30px;">
                                            <div style="margin-right:10px;" class="last-list">
                                                <div style="padding-top:15px;">
                                                    <a style="font-size:14px; text-decoration: none; color:black;" href="http://busanpark.bisco.or.kr/html/main.asp"><p style="text-align: center;">예약하기</p></a>
                                                </div>
                                            </div>
                                            <div class="last-list">
                                                <div style="padding-top:15px;">
    ...
    mapOption = { 
        center: new kakao.maps.LatLng(35.05602, 129.08812), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };
...
// 마커가 표시될 위치입니다 
var markerPosition  = new kakao.maps.LatLng(35.05602, 129.08812); 
...
marker.setMap(map);
var iwContent = '<div style="padding: 1em 2em; margin: 2em 0; font-weight: bold; 5px #000000; "><h4><b>부산 수국 꽃축제</b></h4> <br> <h6><b>부산시 영도구 전망로 119</b></h6> </div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
    iwPosition = new kakao.maps.LatLng(35.05602, 129.08812); //인포윈도우 표시 위치입니다
                                            ...
                                            <div id="tab4" class="tab">
                                                <div class="board_wrap">
                                                    ...
                                                    <div class="borad_list_wrap">
                                                        ...
                                                        <div class="bt_wrap">
                                                            <a href="/Review/reviewWriteForm.jsp?fid=1" class="on">리뷰작성</a>
                                                            <!-- <a href="a">작성</a> -->
                                                        </div>
                                                    </div>
                                                </div>
