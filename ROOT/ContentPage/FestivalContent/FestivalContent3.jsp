...
<%@ page import="org.json.simple.parser.ParseException" %>
                                        ...
                                        <li style="display: flex; width: 480px; justify-content:flex-end; margin-right: 30px;">
                                            <div style="margin-right:10px;" class="last-list">
                                                <div style="padding-top:15px;">
                                                    <a style="font-size:14px; text-decoration: none; color:black;" href="http://www.guponarufes.co.kr/kor/Board/application.php"><p style="text-align: center;">예약하기</p></a>
                                                </div>
                                            </div>
                                            <div class="last-list">
                                                <div style="padding-top:15px;">
        ...
        mapOption = { 
            center: new kakao.maps.LatLng(35.22585, 129.00346), // 지도의 중심좌표
            level: 3 // 지도의 확대 레벨
        };
    ...
    marker.setMap(map);
    var iwContent = '<div style="padding: 1em 2em; margin: 2em 0; font-weight: bold; 5px #000000; "><h4><b>낙동강 구포 나루 축제</b></h4> <br> <h6><b>부산광역시 북구 낙동대로1739번길 257, 화명생태공원 선착장</b></h6> </div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
